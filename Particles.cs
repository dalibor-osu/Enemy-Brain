...
namespace StorybrewScripts
{
    public class Particles : StoryboardObjectGenerator
    {
        ...
        [Configurable] public int FadeInOffset = 0;
        ...
        public override void Generate()
        {
            ...
            for (var i = 0; i < ParticleCount; i++)
            {
                ...
                if (spriteRotation != 0 && !RandomRotation)
                    particle.Rotate(startTime, spriteRotation);

                if (RandomRotation)
                    particle.Rotate(startTime, Random(0, Math.PI * 2));
                ...
                particle.ScaleVec(0, loopDuration, Scale, EndScale);
                particle.Fade(OsbEasing.In, FadeInOffset, FadeInOffset + FadeInTime, 0, color.A);
